            ...
            <ul class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
                ...
                <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem">
                    <a href="/laptop" itemprop="item">
                        <span itemprop="name">Gạch lát nền Thạch Bàn</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <main class="category-content-wrapper flex-b flex-w">
            ...
            <div class="category-content">
                    ...
                    <div class="filter-by-criteria flex-b flex-s align-c">
                        ...
                        <div class="criteria-form">
                            ...
                            <div class="criteria-list flex-b">
                                ...
                                <a class="criteria-item" href="/danh-muc?sort=price-desc">
                                    Giá cao
                                </a>
                ...
                <div class="category-description">
                    <h2 class="category-description-subhead">
                        Gạch lát nền Thạch Bàn
                    </h2>
                    <p>Thạch Bàn Tiền thân là một đơn vị sản xuất gạch ngói được thành lập từ năm 1959. Trải qua hơn 50 năm hoạt động, Thạch Bàn thực sự trưởng thành không ngừng, luôn tạo ra những sản phẩm gạch ngói, gạch ốp lát granite cao cấp đáp ứng được nhu cầu ngày càng cao của khách hàng.</p>
                    <p>
                        <img src="/images/gach-lat-nen-thach-ban.jpg" alt="">
                    </p>
                    <p>Gạch lát nền Thạch Bàn 600x600 mm là một trong những sản phẩm được đông đảo khách hàng trên cả nước lựa chọn bởi đây là dòng gạch kích thước phổ thông, có giá thành tốt, mẫu mã gạch đẹp phù hợp lát sàn phòng khách, gạch lát nền phòng ngủ, gạch lát nền ban công, gạch lát nền hành lang, cầu thang, thang máy.....cho căn hộ, nhà hàng, khách sạn, khu nghỉ dưỡng, trường học, nhà ga, sân bay...</p>
                    <p>Gạch lát nền Thạch Bàn 600x600 mm kế thừa những ưu điểm của dòng sản phẩm trước về độ bóng, men khô, khả năng chống thấm ngược, độ phát màu sắc nét, bề mặt phẳng, ít lỗ châm kim cộng với thiết kế được cập nhật theo xu hướng mới nhất hiện nay, dòng sản phẩm gạch Thạch Bàn 60x60 hứa hẹn sẽ mang đến phong cách không gian sống tinh tế và sang trọng trong năm 2019.</p>
                </div>
            </div>
        </main>
    </div>
